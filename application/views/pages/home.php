		...
		<div class="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
			<div class="lg:col-span-7">
				<div class="md:mr-6 md:mb-20">
					...
					<div class="mt-6">
						<a href="contact-one.html" class="btn btn-light rounded-md mr-2 mt-2"><i class="uil uil-book-reader"></i> Registrate!</a>
						<a href="contact-one.html" class="btn btn-light rounded-md mr-2 mt-2"><i class="uil uil-flask"></i> Ver los experimentos</a>
					</div>
				</div>
			</div><!--end col-->
