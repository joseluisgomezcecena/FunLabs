<!DOCTYPE html>
<html lang="en" class="menu-hidden">
...
<!-- Menu Bar -->
<aside style="display: none;" class="menu-bar menu-hidden">
...
<aside style="display: none" id="customizer" class="sidebar sidebar_customizer">
